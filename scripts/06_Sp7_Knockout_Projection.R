# ==============================================================================
# Script Name: 06_Sp7_Knockout_Projection.R
# Description: Re-analyzes a public Sp7 conditional knockout (cKO) dataset to 
#              validate the p53-driven maturation arrest. Employs anchor-based 
#              label transfer to map the IMC identity, quantifies lineage deviation, 
#              and scores cell cycle arrest phases (G1/S/G2M).
