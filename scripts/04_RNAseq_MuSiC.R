# ==============================================================================
# Script Name: 04_RNAseq_MuSiC.R
# Description: Executes bulk RNA-seq deconvolution using the MuSiC algorithm 
#              with the scRNA-seq dataset as a reference. This script infers 
#              the accumulation of the IMC subpopulation in bulk tissue, 
#              calculates lineage-normalized pathogenic burdens, and generates 
#              the global transcription factor reversal quadrant plot.
