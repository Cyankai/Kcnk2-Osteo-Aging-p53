# ==============================================================================
# Script Name: 05_scVelo.py
# Description: Performs RNA velocity analysis to infer the dynamic transcriptional 
#              kinetics of the osteolineage. Computes the deterministic velocity 
#              vectors to validate the unidirectional differentiation flow in 
#              young (3M) mice and the maturation arrest at the IMC node in aging.
# Input Data:  '3M.loom' (Spliced/unspliced count matrices), UMAP coordinates, 
#              and metadata exported from Seurat.
# Output:      SVG-formatted velocity stream plots.
# ==============================================================================
import scanpy as sc
